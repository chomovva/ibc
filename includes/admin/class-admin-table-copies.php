...
// require_once IBC_INCLUDES . 'trait-reader.php';
class Copies_List_Table extends WP_List_Table {
	...
	function prepare_items(){
		...
		// if ( ! empty( $readers ) ) {
			...
			// }
		// }
		// $this->teims = $this->get_readers();
		// echo "<pre>";
		// var_dump( $this->items );
		// var_dump( $this->items2 );
		// echo "</pre>";
	...
	static function _list_table_css(){
		...
		<style>
			...
			table.logs .column-user_name{ width:15%; }
		</style>
		<?php
	}
	...
	// Однако гораздо удобнее указать их напрямую при выводе ячейки - см ячейку user_name...
